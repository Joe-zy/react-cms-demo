...
import { Form, Input, Select, Checkbox, DatePicker, Col, Radio, Button, Modal, message , Breadcrumb , Steps} from 'antd'
        ...
        return (
            ...
            <Form horizontal onSubmit={this.handleSubmit}>
                <div style={{width:"80%",margin:"20px auto"}}>
                    <Steps current={0}>
                        <Step title="Message" description="填写信息" />
                        <Step title="Upload" description="上传图片" />
                        <Step title="Sending" description="发送至服务器" />
                    </Steps>
                </div>
                <FormItem
                    id="control-input"
